...
pub fn map_key(key: KeyEvent, mode: &Mode) -> Action {
    ...
    match mode {
        Mode::Normal => match (key.code, key.modifiers) {
            ...
            (KeyCode::Char('K'), _) | (KeyCode::Char('k'), KeyModifiers::SHIFT) | (KeyCode::Up, KeyModifiers::SHIFT) => Action::MovePinUp,
            (KeyCode::Char('J'), _) | (KeyCode::Char('j'), KeyModifiers::SHIFT) | (KeyCode::Down, KeyModifiers::SHIFT) => Action::MovePinDown,
